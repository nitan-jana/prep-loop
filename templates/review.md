...
[`policy/mocks.md`](../policy/mocks.md#the-review).
...
Graded per [`policy/grading.md`](../policy/grading.md), against the anchors in
...
Only present in a review that ran the re-grade audit, per
[`policy/grading.md`](../policy/grading.md#the-re-grade-audit). One line on
whether the grader has drifted, and what was done about it.
